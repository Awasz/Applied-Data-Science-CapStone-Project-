...
def update_pie_chart(selected_site):
    if selected_site == 'All':
        # If 'ALL' sites are selected, calculate the success rate for each site
        site_success_rate = spacex_df.groupby('Launch Site')['class'].mean().reset_index()
        site_success_rate.rename(columns={'class': 'Success Rate'}, inplace=True)
        fig = px.pie(site_success_rate, names='Launch Site', values='Success Rate',
